	...
	<div class="container">
		...
		<div class="row">
			...
			<?php 
				...
				{
                    echo '<div class="style-msg errormsg"><div class="sb-msg"><i class="icon-remove"></i><a href="'.base_url().'Sitio/login">Inicie sesión</a> o <a href="'.base_url().'Sitio/registrarse">Regístrese</a> para crear una propuesta sobre este tema</div></div>';
