					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide dark">
							...
							<div class="video-wrap">
								<video poster="<?=base_url();?>public/images/videos/explore.jpg" preload="auto" loop autoplay muted>
									<source src='<?=base_url();?>public/images/videos/explore.mp4' type='video/mp4' />
									<source src='<?=base_url();?>public/images/videos/explore.webm' type='video/webm' />
								</video>
								<div class="video-overlay" style="background-color: rgba(0,0,0,0.55);"></div>
							</div>
						</div>
						<div class="swiper-slide" style="background-image: url('<?=base_url();?>public/images/slider/swiper/3.jpg'); background-position: center top;">
							<div class="container clearfix">
		...
		<section id="content">
			...
			<div class="content-wrap">
					...
					<div class="container clearfix center">
						...
						<div id="portfolio" class="portfolio grid-container portfolio-nomargin clearfix">
							...
							<article class="portfolio-item pf-media pf-icons">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="<?=base_url();?>public/images/portfolio/4/1.jpg" alt="Open Imagination">
									</a>
							...
							<article class="portfolio-item pf-illustrations">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="<?=base_url();?>public/images/portfolio/4/2.jpg" alt="Locked Steel Gate">
									</a>
									<div class="portfolio-overlay">
							...
							<article class="portfolio-item pf-graphics pf-uielements">
								<div class="portfolio-image">
									<a href="#">
										<img src="<?=base_url();?>public/images/portfolio/4/3.jpg" alt="Mac Sunglasses">
									</a>
									<div class="portfolio-overlay">
							...
							<article class="portfolio-item pf-icons pf-illustrations">
								<div class="portfolio-image">
									<a href="#">
										<img src="<?=base_url();?>public/images/portfolio/4/4.jpg" alt="Mac Sunglasses">
									</a>
							...
							<article class="portfolio-item pf-uielements pf-media">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="<?=base_url();?>public/images/portfolio/4/5.jpg" alt="Console Activity">
									</a>
									<div class="portfolio-overlay">
							...
							<article class="portfolio-item pf-graphics pf-illustrations">
								<div class="portfolio-image">
									<a href="#">
										<img src="<?=base_url();?>public/images/portfolio/4/6.jpg" alt="Mac Sunglasses">
									</a>
									<div class="portfolio-overlay" data-lightbox="gallery">
							...
							<article class="portfolio-item pf-uielements pf-icons">
								<div class="portfolio-image">
									<a href="portfolio-single-video.html">
										<img src="<?=base_url();?>public/images/portfolio/4/7.jpg" alt="Backpack Contents">
									</a>
									<div class="portfolio-overlay">
							...
							<article class="portfolio-item pf-graphics">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="<?=base_url();?>public/images/portfolio/4/8.jpg" alt="Sunset Bulb Glow">
									</a>
									<div class="portfolio-overlay">
							...
							<article class="portfolio-item pf-illustrations pf-icons">
								<div class="portfolio-image">
									<a href="#">
										<img src="<?=base_url();?>public/images/portfolio/4/9.jpg" alt="Mac Sunglasses">
									</a>
									<div class="portfolio-overlay" data-lightbox="gallery">
							...
							<article class="portfolio-item pf-graphics pf-media pf-uielements">
								<div class="portfolio-image">
									<a href="portfolio-single-video.html">
										<img src="<?=base_url();?>public/images/portfolio/4/10.jpg" alt="Study Table">
									</a>
									<div class="portfolio-overlay">
							...
							<article class="portfolio-item pf-media pf-icons">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="<?=base_url();?>public/images/portfolio/4/11.jpg" alt="Workspace Stuff">
									</a>
									<div class="portfolio-overlay">
							...
							<article class="portfolio-item pf-illustrations pf-graphics">
								<div class="portfolio-image">
									<a href="#">
										<img src="<?=base_url();?>public/images/portfolio/4/12.jpg" alt="Mac Sunglasses">
									</a>
									<div class="portfolio-overlay" data-lightbox="gallery">
				...
				<section id="section-team" class="page-section topmargin-lg">
					...
					<div class="container clearfix">
						...
						<div class="row">
							...
							<div class="col-lg-6 bottommargin">
								...
								<div class="team team-list clearfix">
									<div class="team-image">
										<img src="<?=base_url();?>public/images/team/4.jpg" alt="Nix Maxwell">
									</div>
									<div class="team-desc">
							...
							<div class="col-lg-6 bottommargin">
								...
								<div class="team team-list clearfix">
									<div class="team-image">
										<img src="<?=base_url();?>public/images/team/2.jpg" alt="Josh Clark">
									</div>
									<div class="team-desc">
							...
							<div class="col-lg-6 bottommargin">
								...
								<div class="team team-list clearfix">
									<div class="team-image">
										<img src="<?=base_url();?>public/images/team/8.jpg" alt="Mary Jane">
									</div>
									<div class="team-desc">
					...
					<div class="section parallax" style="background-image: url('<?=base_url();?>public/images/parallax/3.jpg'); padding: 100px 0;" data-bottom-top="background-position:0px 100px;" data-top-bottom="background-position:0px -100px;">
				...
				<section id="section-testimonials" class="page-section section parallax dark" style="background-image: url('<?=base_url();?>public/images/about/me-parallax.jpg'); padding: 200px 0;" data-bottom-top="background-position:0px 300px;" data-top-bottom="background-position:0px -300px;">
					...
					<div class="col_two_third">
						...
						<div class="col_one_third">
							...
							<div class="widget clearfix">
								...
								<img src="<?=base_url();?>public/images/footer-widget-logo.png" alt="" class="footer-logo">
